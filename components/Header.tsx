      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex justify-between items-center">
        ...
        <Link href="/" className="flex items-center gap-2 shrink-0">
          ...
          <div className="flex flex-col">
            <span className="font-serif font-bold text-lg md:text-xl leading-none text-white">Lawn2Care</span>
            <span className="text-[9px] md:text-[10px] uppercase tracking-widest font-semibold text-secondary">Services LTD</span>
          </div>
        </Link>
