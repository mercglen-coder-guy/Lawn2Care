...
export const metadata: Metadata = {
  ...
  description:
    "Transforming Mississauga Homes into Stunning Outdoor Sanctuaries. Award-winning landscaping & hardscaping since 2018. Specializing in interlocking, patios, and garden design.",
  keywords: [
...
export default function RootLayout({
  ...
  return (
    ...
    >
      <body
        className="antialiased selection:bg-secondary selection:text-white flex flex-col min-h-screen"
